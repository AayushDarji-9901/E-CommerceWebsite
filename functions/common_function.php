...
function getproducts(){
    ...
    if(!isset($_GET['category'])){
        if(!isset($_GET['brand'])){
    $con=mysqli_connect("localhost","root","","newstore");
if(!$con){
   ...
   //  echo $row['product_title'];
    ...
    // $product_keywords=$row['product_keywords'];
     ...
     <div class='card' >
 <img src='./admin_area/product_images/$product_image1' class='card-img-top' alt='$product_title' height='220px'>
 <div class='card-body'>
...
<div class='row'>
    ...
    <div class='col-md-6'>
    <img src='./admin_area/product_images/$product_image2' class='card-img-top' alt='$product_title' height='220px'>

    </div>
    <div class='col-md-6'>
    <img src='./admin_area/product_images/$product_image3' class='card-img-top' alt='$product_title' height='220px'>
